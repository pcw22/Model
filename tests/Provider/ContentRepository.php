...
class ContentRepository extends Repository
{
    ...
    protected function insert(ContentEntity $content)
    {
        // generate an id
    ...
    protected function update(ContentEntity $content)
    {
        ...
        if (!isset($this->entities[$content->id])) {
            throw new \Exception('Content was does not exists, therefore it was not updated.');
        }
    ...
    protected function remove(ContentEntity $content)
    {
        // expire the cache
